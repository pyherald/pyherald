...
infos = {
    '04_02_2022': {
            'article': [
                'feb22/cpp',
                'feb22/new_django',
                'feb22/beazley_oldtimes',
                'feb22/pyside_pypy',
                'feb22/abi',
                'feb22/04_happening',
            ],
            'sidebar': [
                'feb22/bits/black_beta',
                'feb22/bits/arcgis',
                'feb22/bits/quarto',
                'feb22/bits/master_ml',
                'feb22/bits/debian',
                'feb22/bits/nlp',
                'feb22/bits/rich_cli',
                'feb22/bits/unicode',
    ...
    '24_12_2021': {
        'article': [
            'dec21/julia_py',
            'dec21/skip_effbot',
            'dec21/typing_for_perf',
            'dec21/unicode_gotchas',
            'dec21/remove_deprecated'
        ],
        'sidebar': [
            'dec21/best_libs_21',
            'dec21/htmx_flask',
